...
def generate_word_report(data: dict, image_paths: list[str], mcp_response: str) -> str:
    ...
    # Stakeholders (Company and CI representatives)
    ...
    if ci_reps:
        ...
        for rep in ci_reps:
            ...
            doc.add_paragraph(f"- {name} ({title})", style='List Bullet')
    # Operations details
    doc.add_heading('5. Operations', level=1)
...
def record_page(record_id: str):
    ...
    if request.method == 'POST':
        ...
        data = {
            ...
            # Observations fields below will be replaced by operations dict; keep for backward compatibility
        ...
        # Operations details
        operations_keys = ['Receiving', 'Putaway', 'Replenishment', 'Order Management', 'Picking', 'Packing', 'Staging', 'Shipping', 'General']
        operations_data = {}
        ...
        for key in operations_keys:
            ...
            if file and file.filename:
                ...
                saved_images.append(rel_path)  # include in general images for doc generation
            operations_data[key] = {
                'pain': pain,
                'root_cause': root,
                'impact': impact,
        ...
        if not record_data:
            ...
            record_data = {
                ...
                'operations': {k: {'pain': '', 'root_cause': '', 'impact': '', 'images': []}
        ...
        # Provide list of SE names and operations keys to template
        se_names = load_se_names()
        operations_keys = ['Receiving','Putaway','Replenishment','Order Management','Picking','Packing','Staging','Shipping','General']
